...
public sealed class GetGrowthByTeamMemberEndpoint : Endpoint<GetGrowthByTeamMemberRequest, GrowthDto>
{
    ...
    public override async Task HandleAsync(GetGrowthByTeamMemberRequest req, CancellationToken ct)
    {
