...
| Shot | Verdict | Notes |
| --- | --- | --- |
| `04-dashboard` | **match** | Needs Action, Watchlist, Commitment View, Team Pulse, Drift Signals; AI actions deferred (Phase 7) |
...
| `10-projects-detail` | **match** | Project detail + overview tabs; Edit overview / Save |
| `11-team` | **minor deviation** | Thin Phase 5 surface (member list); full hub tabs are Phase 6 |
| `12-team-member` | **minor deviation** | Identity + notes list/read-only; hub tabs Phase 6 |
| `13-settings` | **match** | `settings-stale-days`, Save settings, Azure connection fields |
